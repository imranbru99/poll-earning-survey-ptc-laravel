...
class CategoryController extends Controller
{
	...
	public function index(){
		...
		return view('admin.category.index', compact('page_title', 'categories', 'forums'));
	}
	...
	public function subCategory(){
		...
		return view('admin.category.sub_category', compact('page_title', 'subCategories', 'categories'));
	}
