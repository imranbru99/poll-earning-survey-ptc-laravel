...
@section('content')
        <div class="form-area bg_img" data-background="{{asset('assets/admin/images/2.jpeg')}}">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6">
            <div class="login-area">
              ...
              <form class="action-form mt-50 loginForm" action="{{ url('publisher_user/publisher_user_login') }}" method="post">
                @csrf
                ...
                <div class="form-group text-center">
                  ...
                  <p class="mt-20">@lang('Forget your password?') <a href="{{ route('publisher_user.password.request') }}">@lang('Reset password')</a></p>
                </div>
              </form>
            </div>
          </div>
