                        ...
                        <form action="{{ route('user.deposit.manual.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 text-center">
                                    ...
                                    <h4 class="text-center mb-4">@lang('Please copy the Address and send the exact amount')</h4>

                                    <p class="my-4 text-center">@php echo  $data->gateway->description @endphp <a onclick="myFunction()" href="#" class="w3-right w3-btn"><span class="w3-hide-small" style="color:red"> <i class="fa-solid fa-copy"></i>Copy </span></a></p> 
                                  
                                  
                        <input type="text" value="{{ $data->gateway->account_details }}"  id="myInput" hidden>
