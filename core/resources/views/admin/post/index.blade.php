                                    ...
                                    <tr>
                                        <td data-label="@lang('Topic')">
                                            <span class="font-weight-bold" data-toggle="tooltip"
                                                data-original-title="@lang('Post Title')">
                                                {{ substr(__($data->post_title), 0, 20) }}
                                            </span>
                                            <br />
                                            <span class="font-weight-bold" data-toggle="tooltip"
                                                data-original-title="@lang('Description')">
                                        ...
                                        <td data-label="@lang('Reactions')">
                                            <span class="font-weight-bold" data-toggle="tooltip"
                                                data-original-title="@lang('Up Vote')">@lang('Up Vote')
                                                {{ $data->up_vote }}</span>
                                            <br />
                                            <span class="font-weight-bold" data-toggle="tooltip"
                                                data-original-title="@lang('Down Vote')">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.post.details', $data->id) }}"
                                                        data-id='{{ $data->id }}' data-name='{{ $data->name }}'
                                                        data-icon='{{ $data->icon }}' data-status='{{ $data->status }}'
