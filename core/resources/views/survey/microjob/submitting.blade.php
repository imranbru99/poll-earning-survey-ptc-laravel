                                        ...
                                        @if ($val->deleted_at == null)
                                            <tr>
                                                ...
                                                <td data-label="@lang('Username')"><a
                                                        href="{{ route('admin.users.detail', $val->id) }}">{{ $val->username }}</a>
                                                </td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                            <a class="dropdown-item" data-toggle="modal"
                                                                data-target="#exampleModalAccept" id="AcceptMicrojobId"
                                                                data-attr="{{ route('microJobs.show', $val->id) }}"
                                                                href="#"><i
                                                                    class="menu-icon fas fa-thumbs-up mr-2"></i>
                                                                Approval</a>

                                                            <a class="dropdown-item" href="#" data-toggle="modal"
                                                                data-target="#exampleModalReject" id="RejectMicrojobId"
                                                                data-attr="{{ route('microJobs.delete', $val->id) }} ">
                                                                <i class="menu-icon fas fa fa-ban mr-2"></i>
                                                                Reject
                                                            </a>
                                                            <a class="dropdown-item" href="#" type="button"
                                                                class="btn btn-primary" data-toggle="modal"
                                                                data-target="#exampleModal" id="ViewImageMicrojob"
                                                                data-image="{{ $val->comment }}"
                                                                data-attr="{{ route('microJobs.Image', $val->id) }}"><i
                                                                    class="menu-icon fas fa fa-link mr-2"></i>View Task
                                                                Details</a>
                                                        </div>
                                                    </div>
