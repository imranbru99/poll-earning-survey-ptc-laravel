                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span class="font-weight-bold">
                                @if($deposit->publisher_user_id != null)
                                    <a href="{{ route('admin.publisher.users.detail', $deposit->publisher_user_id) }}">{{ $deposit->publish_user->username }}</a>
                                @else
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12">
                            <button class="btn btn--success ml-1 approveBtn"
                                    ...
                                    @if($deposit->publisher_user_id != null)
                                    data-username="{{ $deposit->publish_user->username }}"
                                    @else
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('admin.deposit.approve')}}" method="POST">
                    @csrf
                     <input type="text" name="id" id="" class="form-control" value="Completed Your Deposit, Recieved Successfully" placeholder="@lang('Reason of reject')" aria-describedby="helpId">
                ...
                <form action="{{ route('admin.deposit.reject')}}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="message" id="" class="form-control" value="You Did not send the Amount Correctly" placeholder="@lang('Reason of reject')" aria-describedby="helpId">
                        </div>
