...
<div class="row mt-5 mb-5">
    <div class="col-md-12">
            ...
            <a href="{{ route('publisher_user.ptc.index') }}" class="btn float-right cmn-btn mb-4" data-toggle="tooltip" data-placement="top"><i class="fa fa-backward"></i> @lang('Go Back') </a>
        </div><br>
        <div class="container card">
            <div class="card-body">

                <form role="form" method="POST" action="{{ route("publisher_user.ptc.update",$id) }}" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="row pt-5 mt-5 border-top">
                    <div class="form-group col-md-12">
                        <button type="submit" class="btn btn--primary btn-block btn-lg" style="background-color: #7367f0 !important;color: white;">@lang('Submit')</button>
                    </div>
                </div>
