...
@section('panel')
<form method="POST" enctype="multipart/form-data" action="{{ route('admin.survey.question.store', $survey->id) }}">
    @csrf
    <div>
                        ...
                        <div class="col-lg-3 col-sm-12 mx-auto">
                            <div class="row">
                                ...
                                <div class="ml-auto  mb-3 mt-3">
                                    <div class="d-flex btnholder flex-column">
                                        <button
                                            class="add-another btn btn-danger addVideoBaseQbtn align-content-center flex"
                                ...
                                <div class="ml-auto  mb-3 ">
                                    <div class="d-flex btnholder flex-column">
                                        <button
                                            class="add-another btn btn-success addIqQuestionbtn align-content-center flex"
                                ...
                                <div class="ml-auto  mb-3 ">
                                    <div class="d-flex btnholder flex-column">
                                        <a href="{{ route('admin.survey.question.importQuestion', $survey->id) }}"
                                           style="background-color: green;color: white;height: 35px;width: 130px;border-radius:5px; padding-top: 7px"> Import Question </a>
                                    </div>
                                </div>
                                <div class="ml-auto  mb-3 mt-3">
                                    <div class="d-flex btnholder flex-column">
