            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{route('publisher_user.deposit.confirm')}}" class="btn btn-block py-3 font-weight-bold mt-4 cmn-btn">@lang('Pay Now')</a>
                        @else
                        <a href="{{route('publisher_user.deposit.manual.confirm')}}" class="btn btn-block py-3 font-weight-bold mt-4 cmn-btn">@lang('Pay Now')</a>
                        @endif
