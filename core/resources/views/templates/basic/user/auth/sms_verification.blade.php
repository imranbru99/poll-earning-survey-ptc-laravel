@extends(active_template() . 'layouts.auth')
                ...
                <div class="col-md-8">
                    <div class="card shadow-inset  border-0">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="email" name="phone" readonly placeholder="Enter Your Username"
                        ...
                        <div class="card-footer text-muted">
                            @lang('When don\'t sent any code your phone') <a class="btn-link"
                                href="{{ route('user.user.sendVcode') }}?phone={{ auth()->user()->phone }}">
                                @lang('Resend code')</a>
