...
class UserPlanController extends Controller
{
    public function index(){
        ...
        return view('admin.user_plan.index')->with(compact('page_title','userPlans'));
    }
    ...
    public function addUserPlan(Request $request){
        ...
        return view('admin.user_plan.add')->with(compact('page_title'));
    }
    ...
    public function editUserPlan($id , Request $request){
        ...
        return view('admin.user_plan.edit')->with(compact('page_title','userPlan','id'));
    }
