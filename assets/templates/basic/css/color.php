<?php
    ...
    if ( isset( $_GET[ 'color1' ] ) && $_GET[ 'color1' ] != '' ) {
        $color1 = "#F168BF".$_GET['color1'];
    }
    if ( isset( $_GET[ 'color2' ] ) && $_GET[ 'color2' ] != '' ) {
        $color2 = "#CC5500".$_GET['color2'];
    }
    if ( isset( $_GET[ 'color3' ] ) && $_GET[ 'color3' ] != '' ) {
        $color3 = "#ff0000".$_GET['color3'];
    }
    ...
    function checkhexcolor3($color3) {
        return preg_match('/^#[a-f0-9]{6}$/i', $color3);
      }
    ...
    if( !$color3 || !checkhexcolor3( $color3 ) ) {
        $color3 = "#2df78b";
      }
?>
