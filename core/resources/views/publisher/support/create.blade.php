        ...
        <div class="card">
            <div class="card-header">
                <div class="col-md-12 mb-30">
                    <ul class="right">
                        <li>
                            <a href="{{route('publisher_user.ticket') }}" class="btn float-right cmn-btn" data-toggle="tooltip" data-placement="top" title="@lang('My Support Ticket')">
            ...
            <div class="card-body">
                <div class="row mb-60-80">
                    <div class="col-md-12 mb-30">
                        <form action="{{route('publisher_user.ticket.store')}}" role="form" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row ">
