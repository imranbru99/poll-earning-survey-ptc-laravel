                ...
                <table class="table table--light style--two">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-label="@lang('Limit/Day')">{{ $plan->survey_limit}} @lang('Survey Limit')</td>
                            <td data-label="@lang('Limit/Day')">{{ $plan->daily_income}} @lang('TK')</td>
                            <td data-label="@lang('Monthly Refer')">{{ $plan->refer_monthly}}</td>
                            <td data-label="@lang('Limit/Day')">{{ $plan->monthly_income}} @lang('TK')</td>
...
<script>
    (function($){
        ...
        $('.editBtn').on('click', function() {
            ...
            modal.find('input[name=daily_limit]').val($(this).data('survey_limit'));
            ...
            modal.find('input[name=refer_monthly]').val($(this).data('monthly_income'));
