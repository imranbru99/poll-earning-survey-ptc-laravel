                ...
                <form role="form" method="POST" action="{{ route('admin.ptc.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                       ...
                       <div class="form-group col-md-8">
                        ...
                        <input type="text" name="title" class="form-control form-control-lg" value="News" placeholder="@lang('Title')" required>
                    </div>

                    <div class="form-group col-md-4">
                        <label>@lang('Amount') <span class="text-danger">*</span></label>
                        <div class="input-group">
                            <input type="text" name="amount" class="form-control form-control-lg" value="1" placeholder="@lang('User will get ...')" required>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group">
                            <input type="text" name="duration" class="form-control form-control-lg" value="15" placeholder="@lang('Duration')" required>
                            <div class="input-group-append">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group">
                            <input type="text" name="max_show" class="form-control form-control-lg" value="1000" placeholder="@lang('Maximum Show') " required>
                            <div class="input-group-append">
